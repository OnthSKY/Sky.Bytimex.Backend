...
public class CategoryOrdersReportEntity
{
    [DbManager.mColumn("category_id")] public Guid? CategoryId { get; set; }
    [DbManager.mColumn("category_name")] public string CategoryName { get; set; } = string.Empty;
