...
public interface IAdminStockMovementService
{
...
public class AdminStockMovementService : StockMovementServiceBase, IAdminStockMovementService
{
    public AdminStockMovementService(IStockMovementRepository movementRepository,
