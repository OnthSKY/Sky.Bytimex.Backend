...
[ApiController]
[Route("api/vendor/order-details")]
[ApiVersion("1.0")]
public class OrderDetailController : VendorBaseController
{
    private readonly IVendorOrderDetailService _orderDetailService;

    public OrderDetailController(IVendorOrderDetailService orderDetailService)
    {
