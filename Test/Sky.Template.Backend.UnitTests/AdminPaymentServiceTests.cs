...
public class AdminPaymentServiceTests
{
    ...
    private AdminPaymentService CreateService(Mock<IPaymentRepository> repoMock)
    {
        ...
        return new AdminPaymentService(repoMock.Object, accessor.Object, gatewayResolver.Object);
    }
