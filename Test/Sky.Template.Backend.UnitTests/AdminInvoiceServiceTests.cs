...
public class AdminInvoiceServiceTests
{
    private readonly Fixture _fixture = new();

    private AdminInvoiceService CreateService(Mock<IInvoiceRepository> repoMock)
    {
        ...
        return new AdminInvoiceService(repoMock.Object, orderRepo.Object, accessor.Object);
    }
